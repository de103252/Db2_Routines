 ...
 * 
 * <p>This class provides thread-safe date/time formatting and parsing
 ...
 * with the same patterns and locales.</p>
 *
...
public class Date {
     ...
     * 
     * <p>This method uses a cache to improve performance when the same
     * pattern and locale combination is used repeatedly.</p>
     *
     ...
     * 
     * <p>This method uses the modern java.time API for better performance
     * and thread safety compared to SimpleDateFormat.</p>
     *
     ...
     * 
     * <p>This method caches the result to avoid repeated computation,
     * as the list of available locales does not change during runtime.</p>
     *
     ...
     * 
     * <p>This method implements a simple cache eviction strategy when
     * the cache size exceeds MAX_CACHE_SIZE.</p>
     *
